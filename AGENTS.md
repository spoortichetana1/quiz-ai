...
`.codex/skills/` contains reusable execution knowledge.
...
`.codex/agents/` contains specialized engineering viewpoints.
...
`.codex/memory/` contains reusable repository knowledge.
